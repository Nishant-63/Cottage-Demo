...
const CATEGORY_IMAGES = {
  appetizers: 'https://images.unsplash.com/photo-1541014741259-de529411b96a?w=700&q=80',
  soups:      'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=700&q=80',
  flatbread:  'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=700&q=80',
  mains:      'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=700&q=80',
  desserts:   'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=700&q=80',
  cocktails:  'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=700&q=80',
  bar:        'https://images.unsplash.com/photo-1527281400683-1aae777175f8?w=700&q=80',
}
...
export function getDishImage(dishName, sectionTitle, tabKey) {
  ...
  // 3. Tab-level fallback
  return CATEGORY_IMAGES[tabKey] || CATEGORY_IMAGES.appetizers
}
